...
public class MuteMethods {
    ...
    public static void applyMute(String sender, String target, Integer pretime, String timeunit, String reason, String server) {
        ...
        switch (unit) {
            ...
            case "semaines":
                ...
                if(PunishSQL.applyMute(sender, target, now, newtime1, reason, server)) {

                    sendMuteMSG(target, reason, sender);
                    return;
                } else {
            ...
            case "jours":
                ...
                if(PunishSQL.applyMute(sender, target, now, newtime2, reason, server)) {
            ...
            case "heures":
                ...
                newtime3 = newtime3 * recidiv + 1;

                if(PunishSQL.applyMute(sender, target, now, newtime3, reason, server)) {
            ...
            case "minutes":
                ...
                if(PunishSQL.applyMute(sender, target, now, newtime, reason, server)) {
            ...
            case "secondes":
                ...
                if(PunishSQL.applyMute(sender, target, now, newtime4, reason, server)) {
    ...
    public static void sendMuteMSG(String p, String r, String s) {
        ...
        if(pp != null) {
            if (pp.isConnected()) {
                ...
                pp.sendMessage(TextComponent.fromLegacyText("§cVous avez été réduit au silence."));
                pp.sendMessage(TextComponent.fromLegacyText("§cInfraction: " + r));
                pp.sendMessage(TextComponent.fromLegacyText(" "));
            }
        }
